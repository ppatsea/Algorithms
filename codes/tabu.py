...
def tabu_search(processing_times, tabu_size, num_iterations):
    ...
    for iteration in range(num_iterations):
        ...
        tabu_list.append(new_permutation)
...
def gantt_chart(permutation, makespan):
    ...
    for i, machine in enumerate(machines):
        ...
        for j, end_time in enumerate(machine):
            plot.barh(i, end_time - machine_start_time, left=machine_start_time, color=f"C{i}", alpha=0.7)
...
""""
Αν ο χρήστης θέλει τα αποτελέσματα να εκτυπώνονται στην οθόνη, βάζει σε σχόλια τις γραμμές: 209-258,
και στη γραμμή 187 επιλέγει το εύρος των αρχείων που επθυμεί να εκτελέσει.

Αντιθέτως, αν επιθυμεί τα αποτελέσματα να εγγράφονται στο αρχείο με όνομα "results_tabu_search.txt", τοποθετεί σε σχόλια τις γραμμές 159-196,
και στη γραμμή 245 επιλέγει το εύρος των αρχείων που θέλει να εκτελέσει.
"""